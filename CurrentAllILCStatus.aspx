<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CurrentAllILCStatus.aspx.cs" Inherits="CurrentAllILCStatus" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3>সকল আইসিটি লার্নিং সেন্টারের বিস্তারিত স্ট্যাটাস</h3>
