			  ...
			  <table border="2" class="table">
			    <tr class="success table-tr">
			    	...
			    	<th>
                        ...
                        <asp:RequiredFieldValidator ID="schoolNameRFV" runat="server"  ForeColor="Red" ErrorMessage="Please enter the school name" ControlToValidate="schoolNameTB"></asp:RequiredFieldValidator>
			    	</th>
			    </tr>
                 <tr class="table-tr">
			    	<td>স্কুল ইআইআইএন*</td>
                ...
                <tr class="table-tr">
                    <td>হেডমাস্টার/মাদ্রাসা সুপার এর নাম</td>
                    <td>
                        <asp:TextBox ID="headNameTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>হেডমাস্টার/মাদ্রাসা সুপার এর ফোন</td>
                    <td>
                        <asp:TextBox ID="headPhoneTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>হেডমাস্টার/মাদ্রাসা সুপার এর ইমেইল</td>
                    <td>
                        <asp:TextBox ID="headEmailTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>আইসিটি শিক্ষক/শিক্ষিকা এর নাম</td>
                    <td>
                        <asp:TextBox ID="trainerNameTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>আইসিটি শিক্ষক/শিক্ষিকা এর ফোন</td>
                    <td>
                        <asp:TextBox ID="trainerPhoneTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>আইসিটি শিক্ষক/শিক্ষিকা এর ইমেইল</td>
                    <td>
                        <asp:TextBox ID="trainerEmailTB" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>স্কুল এর ইমেইল</td>
                    <td>
                        <asp:TextBox ID="schoolEmail" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>স্কুল এর ওয়েবসাইট</td>
                    <td>
                        <asp:TextBox ID="schoolWebsite" runat="server" Width="450px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td></td>
