<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllSchoolDetails.aspx.cs" Inherits="AllSchoolDetails" %>
                        ...
                        <nav class="navbar navbar-default">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li  class="active"><a id="reportsLink" href="Reports.aspx" runat="server" visible="false">Reports</a></li>
