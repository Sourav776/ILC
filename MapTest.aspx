<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MapTest.aspx.cs" Inherits="Map" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <script type="text/javascript">
            ...
            //Getting values from Login Session
            var lat = '<%= Session["latitude"] %>';
            var lon = '<%= Session["longitude"] %>';
            var userType = '<%= Session["userType"] %>';

            //Super admin & Sesip admin will see a zoomed out view
