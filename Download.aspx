...
<body>
    <form id="form1" runat="server">
                        ...
                        <nav class="navbar navbar-default">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a id="reportsLink" href="Reports.aspx" runat="server" visible="false">Reports<span class="sr-only">(current)</span></a></li>
                                    ...
                                    <li class="active"><a href="Download.aspx">Downloads<span class="sr-only">(current)</span></a></li>
        ...
        <div class="container downloadscript">
            <div class="row">
                <div class="col-md-12">
                    <center>
