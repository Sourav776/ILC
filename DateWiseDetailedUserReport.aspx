<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWiseDetailedUserReport.aspx.cs" Inherits="DateWiseDetailedUserReport" %>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <br />
                        <br />
                        <asp:DropDownList ID="ilcNameDDL" runat="server" DataSourceID="ilcNameDS" DataTextField="ILCEng" DataValueField="ILCEng"></asp:DropDownList>
                        <asp:SqlDataSource runat="server" ID="ilcNameDS" ConnectionString='<%$ ConnectionStrings:ILCDBConnectionString %>' SelectCommand="SELECT [ILCEng] FROM [Location]"></asp:SqlDataSource>
                            <br />
                            <br />
...
<%--                            <CR:CrystalReportViewer ID="crv" runat="server" AutoDataBind="true" ToolPanelView="None" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False"></CR:CrystalReportViewer>--%>
                                <CR:CrystalReportViewer ID="crv" runat="server" AutoDataBind="true"></CR:CrystalReportViewer>
                        </div>
