<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportsOld.aspx.cs" Inherits="Reporting" %>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6 table-responsive">
                    <table border="2" class="table">
                        <tr id="allSchoolTR" class="success table-tr" visible="false" runat="server">
                            <td>আইসিটি লার্নিং সেন্টারের তালিকা</td>
                            <td>
                                <asp:Button ID="rptAllSchoolBTN" CssClass="btn btn-success" runat="server" Text="Generate Report" OnClick="rptAllSchoolBTN_Click" />
                            </td>
                        </tr>
                        <tr id="specificSchoolTR" class="success table-tr" visible="false" runat="server">
                            <td>নির্দিষ্ট আইসিটি লার্নিং সেন্টারের তথ্য</td>
                            <td>
                                <asp:Button ID="rptSpecificSchoolBTN" CssClass="btn btn-success" runat="server" OnClick="rptSpecificSchoolBTN_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="currentILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>আইসিটি লার্নিং সেন্টারের এই মুহূর্তের স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="rptCurrentILCStatusBTN" OnClick="rptCurrentILCStatusBTN_Click" CssClass="btn btn-success" runat="server" Text="Generate Report" />
                            </td>
                        </tr>
                       <tr id="CurrentSpecificILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>বর্তমানে নির্দিষ্ট আইএলসি স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="rptCurrentSpecificILCStatus" OnClick="rptCurrentSpecificILCStatus_Click" CssClass="btn btn-success" runat="server" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="dateWiseILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>তারিখ অনুযায়ী আইএলসি এর স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="rptDateWiseILCStatusBTN" CssClass="btn btn-success" runat="server" OnClick="rptDateWiseILCStatusBTN_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="dateWiseILCStatusDetailsTR" class="success table-tr" visible="false" runat="server">
                            <td>তারিখ অনুযায়ী আইএলসি এর বিস্তারিত স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="dateWiseILCStatusDetailsBTN" CssClass="btn btn-success" runat="server" OnClick="dateWiseILCStatusDetailsBTN_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="dateWiseAllILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>তারিখ অনুযায়ী আইসিটি লার্নিং সেন্টারের সার্ভারের স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="dateWiseAllILCStatus" CssClass="btn btn-success" runat="server" OnClick="dateWiseAllILCStatus_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="distWiseTodaysILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>জেলা অনুযায়ী আজকের আইএলসি স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="rptDistWiseTodaysILCStatus" CssClass="btn btn-success" runat="server" OnClick="rptDistWiseTodaysILCStatus_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="divWiseTodaysILCStatusTR" class="success table-tr" visible="false" runat="server">
                            <td>বিভাগ অনুযায়ী আজকের আইএলসি স্ট্যাটাস</td>
                            <td>
                                <asp:Button ID="rptDivWiseTodaysILCStatus"  CssClass="btn btn-success" runat="server" OnClick="rptDivWiseTodaysILCStatus_Click" Text="Generate Report" />
                            </td>
                        </tr>
                        <tr id="ilcRankingTR" class="success table-tr" visible="false" runat="server">
                            <td>আইএলসি র‍্যাঙ্কিং</td>
                            <td>
                                <asp:Button ID="rptILCRanking"  CssClass="btn btn-success" runat="server" OnClick="rptILCRanking_Click" Text="Generate Report" />
                            </td>
                        </tr>
                    </table>
