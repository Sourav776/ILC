...
public partial class DateWiseAllILCStatus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            rprt.Load(Server.MapPath("~/rptDateWiseAllILCStatus.rpt"));
            ...
            SqlCommand cmdRpt = new SqlCommand("SP_Date_Wise_Total_ILC_Server_LoggedOn", conRpt);
