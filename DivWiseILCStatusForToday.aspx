<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DivWiseILCStatusForToday.aspx.cs" Inherits="DivWiseILCStatusForToday" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="row">
                ...
                <br />
                <br />
                <asp:Label ID="ilcDivisionLBL" runat="server" Text="Select District" Font-Size="Large"></asp:Label>
                <br />
                <br />
                <asp:DropDownList ID="ilcDivisionDDL" runat="server" DataSourceID="ilcDivisionDS" DataTextField="DivCode" DataValueField="DivCode"></asp:DropDownList>
                <asp:SqlDataSource runat="server" ID="ilcDivisionDS" ConnectionString='<%$ ConnectionStrings:ILCDBConnectionString %>' SelectCommand="SELECT [DivCode] FROM [tblDivision]"></asp:SqlDataSource>
